...
// Constants
  /* Get property */
  /* Set property */
var EXIT_OK, FIRST, LAST, LEFT, NULL, ONE, ONLY, PENULTIMATE, RIGHT, SECOND, TWO, all_beats_one, alto, apply_to_all, apredec, aprodec, arr, asyncrange3, at, ato, azip, azip2, cc, cl, concarr, constr, cps, cps2, empty, enamerate, ensure, enumerate, extend, first, gen, generator, gp, indel, indelone, is_arr, join, last, len, lswap, map, mapk, max, min, naturange, noop, only, pack, penultimate, pk, predec, prodec, pu, refusempty, rswap, second, sp, split, swap, times, u, v,
  splice = [].splice;
...
sp = function(key, val, obj) {
  return obj[key] = val;
};

// Move first argument of function to end of its arguments
export var roll = function(fn, ...not_callable_args) {
  var callable_arg, ref;
  ref = not_callable_args, [...not_callable_args] = ref, [callable_arg] = splice.call(not_callable_args, -1);
...
extend = function(arrg, ...entts) {
  arrg = ensure.array(arrg);
  return arrg.concat(entts);
};

concarr = cc = function(...arrgs) {
...
// Named enumerate
enamerate = function*(iterable, entry_name = 'val', index_name = 'idx', start_from = NULL) {
